                ...
                <div className="grid lg:grid-cols-3 gap-12">
                    <div className="lg:col-span-1">
                        ...
                        <div className="space-y-4">
                            <div className="p-4 bg-secondary-container/30 rounded-xl border border-secondary-container flex gap-4">
                            ...
                            <div className="p-4 bg-primary-fixed/30 rounded-xl border border-primary-fixed flex gap-4">
                    ...
                    <div className="lg:col-span-2 grid md:grid-cols-2 gap-gutter">
                        <div className="bg-surface-container-lowest p-8 rounded-3xl border border-outline-variant/30 hover:shadow-md transition-all">
                            <span className="material-symbols-outlined text-4xl text-primary mb-6">emergency</span>
